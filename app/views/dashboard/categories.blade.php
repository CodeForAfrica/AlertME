      ...
      @foreach ( $categories as $category )
        <div class="media">
          <a class="pull-left" href="#">
            <img class="media-object" src="{{ $category->icon_url != '' ? $category->icon_url : '/assets/img/icons/svg/retina.svg'; }}" alt="icon_url">
          </a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger btn-embossed btn-wide" id="category-delete">Delete Category</button>
        </div>
